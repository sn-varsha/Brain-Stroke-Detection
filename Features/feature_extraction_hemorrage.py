...
IMG_DIR = "/Users/emin/Library/CloudStorage/GoogleDrive-eminsoylemezzz@gmail.com/My Drive/1. PROJECTS/BioMedical Dataset/İNME VERİ SETİ/Eğitim Veri Seti Kanama/Kanama Veri Seti/PNG"  # Beyin görüntüleri
MASK_DIR = "/Users/emin/Library/CloudStorage/GoogleDrive-eminsoylemezzz@gmail.com/My Drive/1. PROJECTS/BioMedical Dataset/İNME VERİ SETİ/Eğitim Veri Seti Kanama/Kanama Veri Seti/MASK"   # Maskelerin bulunduğu klasör
features_list = []
...
df_features.to_csv("features_kanama.csv", index=False)
print("✅ Maskelenmiş bölgeden feature'lar çıkarıldı ve kaydedildi.")