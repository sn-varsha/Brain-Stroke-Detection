...
clf = LogisticRegression(
    ...
    C=1.0,                 # Regularization parameter (1.0: default)
    solver='saga',         # Works well for large datasets
    max_iter=1000,         # Higher iteration limit
...
# 9. Coefficient magnitude instead of Feature Importance
coef = np.mean(np.abs(clf.coef_), axis=0)  # Mean absolute coefficient
